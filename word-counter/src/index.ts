...
let askedParagraph: { paragraph: string };
...
const printingValues = () => {
  console.log(
    "The number of characters in the the paragraph are=",
    chalk.bgYellow.black(askedParagraph.paragraph.length)
  );
  console.log(
    "The number of words in the the paragraph are=",
